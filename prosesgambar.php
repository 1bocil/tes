    ...
    if (isset($_POST["save"])) {
        ...
        if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
            if ($ukuran < 1044070) {
                ...
                $query = mysqli_query($koneksi, "insert into tb_barang (kode_barang,nama_barang,satuan,harga_modal,harga_jual,gambar) values ('$kode_barang','$nama_barang','$satuan','$harga_modal','$harga_jual','$namafile')");
                if ($query) {
